...
`GET` `/api/public/v2/search`

Example request: `https://www.example.com/api/public/v2/search?per_page=3&locale=en&currency=EUR`

Response file: [/api_calls/public/search/rentals-response.json](/api_calls/public/search/rentals-response.json)
